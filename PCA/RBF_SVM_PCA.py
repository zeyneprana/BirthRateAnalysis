...
results = cross_validate(rbf_svm, X_pca, y, cv=10, scoring=scoring)

# Sonuçları yazdırıyoruz
print("RBF SVM Modeli Sonuçları (10 Cross Validation) (PCA)\n")
...
"""
RBF SVM Modeli Sonuçları (10 Cross Validation) (PCA)
