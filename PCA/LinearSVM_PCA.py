...
results = cross_validate(linear_svc, X_pca, y, cv=10, scoring=scoring)

# Sonuçları yazdırıyoruz
print("LinearSVM Modeli Sonuçları (10 Cross Validation) (PCA)\n")
...
"""
LinearSVM Modeli Sonuçları (10 Cross Validation) (PCA)
