...
results = cross_validate(dt, X_pca, y, cv=10, scoring=scoring)

# Sonuçları yazdırıyoruz
print("Decision Tree Modeli Sonuçları (10 Cross Validation) (PCA)\n")
...
"""
Decision Tree Modeli Sonuçları (10 Cross Validation) (PCA)
