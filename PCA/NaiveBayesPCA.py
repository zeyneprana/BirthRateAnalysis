...
results = cross_validate(nb, X_pca, y, cv=10, scoring=scoring)

# Sonuçları yazdırıyoruz
print("Naive Bayes Modeli Sonuçları (10 Cross Validation) (PCA)\n")
...
"""
Naive Bayes Modeli Sonuçları (10 Cross Validation) (PCA)
