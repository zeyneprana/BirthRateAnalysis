...
def fitness_function(bitstring):
    ...
    scores = cross_val_score(knn, X_selected, y_np, cv=5, scoring='accuracy')
...
results = cross_validate(knn, X_selected, y_np, cv=10, scoring=scoring)

print("\nKNN Modeli (GA ile Seçilen Özelliklerle - 10 Katlı CV)\n")
