...
# 6. SEÇİLEN ÖZELLİKLER
X_selected = X_np[:, selected_indices]

# 7. RBF SVM VE METRİKLER
...
results = cross_validate(svm_rbf, X_selected, y_np, cv=10, scoring=scoring)

print("\nRBF SVM Modeli (GA ile Seçilen Özelliklerle - 10 Katlı CV)\n")
