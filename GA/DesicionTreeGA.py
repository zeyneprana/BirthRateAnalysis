...
def fitness_function(bitstring):
    ...
    scores = cross_val_score(dt, X_selected, y_np, cv=5, scoring='accuracy', n_jobs=-1)
...
results = cross_validate(dt, X_selected, y_np, cv=10, scoring=scoring)

print("\nDecision Tree Modeli (GA ile Seçilen Özelliklerle - 10 Katlı CV)\n")
