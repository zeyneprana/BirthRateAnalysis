...
# 2. GA FITNESS FONKSİYONU (Random Forest ile)
def fitness_function(bitstring):
    ...
    scores = cross_val_score(rf, X_selected, y_np, cv=5, scoring='accuracy')
...
results = cross_validate(rf, X_selected, y_np, cv=10, scoring=scoring)

print("\nRandom Forest Modeli (GA ile Seçilen Özelliklerle - 10 Katlı CV)\n")
