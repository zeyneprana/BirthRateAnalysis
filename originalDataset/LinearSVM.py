...
#Linear SVM Modeli
svm = LinearSVC(random_state=42, max_iter=10000)  # max_iter artırmak önemli olabilir
...
results = cross_validate(svm, X_scaled, y, cv=10, scoring=scoring)


# Sonuçları yazdır
print("Linear SVM Modeli Sonuçları (10-Fold Cross Validation)\n")
...
"""
Linear SVM Modeli Sonuçları (10-Fold Cross Validation)
