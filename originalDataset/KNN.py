...
#Metrikleri ölçmek için sklearn'dan hazır fonksiyonları kullanıyoruz:
scoring = {
...
#Bu adımda, veri setini 10 parçaya bölüyoruz (cross-validation). Model 10 kez eğitiliyor ve her seferinde farklı bir grup test ediliyor.
results = cross_validate(knn, X, y, cv=10, scoring=scoring)

#Sonuçları yazdırıyoruz
print("KNN Modeli Sonuçları (10 Cross Validation)\n")
...
"""
KNN Modeli Sonuçları (10 Cross Validation)
