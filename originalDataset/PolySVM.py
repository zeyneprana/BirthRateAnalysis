...
# Polynomial Kernel SVM modeli (degree=3 varsayılan)
poly_svm = SVC(kernel='poly', degree=3, C=1, gamma='scale', random_state=42)

# Skorlayıcıları tanımla
scoring = {
...
results = cross_validate(poly_svm, X_scaled, y, cv=10, scoring=scoring)

# Sonuçları yazdır
print("Polynomial Kernel SVM Modeli Sonuçları (10-Fold Cross Validation)\n")
...
"""
Polynomial Kernel SVM Modeli Sonuçları (10-Fold Cross Validation)
